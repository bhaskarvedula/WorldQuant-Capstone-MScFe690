...
This is a project carried out for capstone required for completing MScFE from WorldQuant University (Group 9184)
## **Concepts**
...
The code written **(MainNotebook.ipynb *[1,2 3, 4 and 5]*)** for this capstone has been compartmentalized as multiple section with each section capturing a particular functionality or activity. This is to enable ease of understanding the entire code.
